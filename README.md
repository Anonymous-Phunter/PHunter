...
We tried the online trial [sites](https://scantist.io) given in the paper: ATVHunter: Reliable Version Detection of Third-Party Libraries for Vulnerability Identification in Android Applications. However, the website reported that 52 components are existing in this apk, but the above 3 TPLs are not present in among them. The following two figures show some of the test results of the website.    
<div align="center">
       <div>
